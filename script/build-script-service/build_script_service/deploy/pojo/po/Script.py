...
class Script:
    ...
    def __init__(self, pyName="", className="", packageName="", projectName="", lineProjectName="",
                 scriptProjectName="", scriptLineProjectName="", targetProjectName="", targetLineProjectName="",
                 targetLaunchPath="", targetTomlPath="", targetBuildPath="", targetConfigPath="", targetDistPath="",
                 pyPath="", yamlConfig="", scriptConfig="", scriptPath="", consoleScripts="", codePaths=set(),
                 modules=set()):
        self._pyName = pyName
        self._pyPath = pyPath
        ...
        self._scriptLineProjectName = scriptLineProjectName
        self._targetProjectName = targetProjectName
        self._targetLineProjectName = targetLineProjectName
    ...
    @staticmethod
    def of(pyName, className, packageName, projectName, lineProjectName, scriptProjectName, scriptLineProjectName,
           targetProjectName, targetLineProjectName, targetLaunchPath, targetTomlPath, targetBuildPath,
           targetConfigPath, targetDistPath, pyPath, yamlConfig, scriptConfig, scriptPath, consoleScripts, codePaths,
           modules):
        return Script(pyName, className, packageName, projectName, lineProjectName, scriptProjectName,
                      scriptLineProjectName, targetProjectName, targetLineProjectName, targetLaunchPath, targetTomlPath,
                      targetBuildPath, targetConfigPath, targetDistPath, pyPath, yamlConfig, scriptConfig, scriptPath,
                      consoleScripts, codePaths, modules)
    ...
    def getByPath(appletDir=""):
        ...
        targetDir = FileUtil.dirname(FileUtil.appDir(False)) + sep + "target"
        ...
        for file in lstFile:
            ...
            scriptPath = scriptDir + sep + projectName + sep + scriptName
            scriptConfig = scriptDir + sep + projectName + sep + yamlName
            scriptProjectName = scriptDir + sep + projectName
            scriptLineProjectName = scriptDir + sep + projectName + sep + lineProjectName
            targetLineProjectName = targetDir + sep + projectName + sep + "src" + sep + lineProjectName
            targetLaunchPath = FileUtil.dirname(targetLineProjectName) + sep + scriptName
            targetTomlPath = targetDir + sep + projectName + sep + "pyproject.toml"
            targetDistPath = targetDir + sep + projectName + sep + "dist"
            targetConfigPath = targetLineProjectName + sep + yamlName
            targetProjectName = targetDir + sep + projectName
            ...
            lstScript.append(
                Script.of(pyName, className, packageName, projectName, lineProjectName, scriptProjectName,
                          scriptLineProjectName, targetProjectName, targetLineProjectName, targetLaunchPath,
                          targetTomlPath, targetBuildPath, targetConfigPath, targetDistPath, pyPath, yamlConfig,
                          scriptConfig, scriptPath, consoleScripts, codePaths, modules))
        return lstScript
    ...
    @property
    def scriptLineProjectName(self):
        return self._scriptLineProjectName

    @scriptLineProjectName.setter
    def scriptLineProjectName(self, value):
        self._scriptLineProjectName = value
    ...
    @property
    def targetLineProjectName(self):
        return self._targetLineProjectName

    @targetLineProjectName.setter
    def targetLineProjectName(self, value):
        self._targetLineProjectName = value
